  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        <div>
          <h1 className="font-display text-3xl font-bold text-foreground">Report Garbage</h1>
          <p className="text-muted-foreground mt-1">Geo-tag and report garbage for quick cleanup.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            className="lg:col-span-1 rounded-2xl bg-card border border-border p-6 eco-shadow"
          >
            <h2 className="font-display text-lg font-semibold text-foreground mb-4">New Complaint</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-11 eco-gradient text-primary-foreground font-semibold hover:opacity-90 transition-opacity"
              >
                {loading ? (
            ...
            {complaints.map((c, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="rounded-2xl bg-card border border-border p-5 flex items-start gap-4"
                >
